...
--
-- Class DailyQueueCounter as table daily_queue_counters
--
...
--
-- Class MenuItem as table menu_items
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('pchaa', '20260225060211902', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260225060211902', "timestamp" = now();
